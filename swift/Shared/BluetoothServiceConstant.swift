...
let ParingServiceDummyChacteristicUUIDKey: String = "FD80F91A-C0EB-4CD4-A89B-663408E69268" //dummy to :"fool  swift and iOS" service, only needed when  makeing a connection, which don't do use, but without it no service appear/exist.
...
let manufacturerId: UInt16 = 65535
let pairingPackage: [UInt8] = [0x9c, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]
